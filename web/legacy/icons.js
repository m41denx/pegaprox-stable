        ...
        const Icons = {
            ...
            // LW: LifeBuoy icon for support bundle - Feb 2026
            LifeBuoy: () => (
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <circle cx="12" cy="12" r="10" strokeWidth={2} />
                    <circle cx="12" cy="12" r="4" strokeWidth={2} />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.93 4.93l4.24 4.24m5.66 0l4.24-4.24m0 14.14l-4.24-4.24m-5.66 0l-4.24 4.24" />
                </svg>
            ),
            // MK: Box icon for containers/packages - Feb 2026
            Box: ({ className, style }) => (
                <svg className={className || "w-5 h-5"} style={style} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                </svg>
            ...
            ChevronDown: (props) => (
                <svg className={props.className || "w-4 h-4"} style={props.style} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            // LW: Feb 2026 - needed for corporate VM detail back button
            ChevronLeft: (props) => (
                <svg className={props.className || "w-4 h-4"} style={props.style} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            // LW: MessageSquare icon for discussions - Feb 2026
            MessageSquare: () => (
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                </svg>
            ),
            // NS: Feb 2026 - PBS File Browser icons
            ArrowLeft: () => (
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
